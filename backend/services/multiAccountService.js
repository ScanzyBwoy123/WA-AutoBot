...
class MultiAccountService {
  ...
  checkAccount(phone) {
     ...
     *
     * This must happen after the account
     * existence check and before expiry checks.
     */
    if (
      this.isDeveloperAccount(
        phone
      )
    ) {
      return {
  ...
  setPairingCode(
     ...
     *
     * Developer test account is allowed
     * through isAccountActive().
     */
    if (
  ...
  getStats() {
     ...
     *
     * Developer test accounts are
     * intentionally ignored here so
     * normal subscription statistics
     * remain unchanged.
     */
    for (
